...
public class QuicksandBoldTurquoiseCapitalView extends android.support.v7.widget.AppCompatTextView {
    public QuicksandBoldTurquoiseCapitalView(Context context, AttributeSet attrs) {
        super(context, attrs);
